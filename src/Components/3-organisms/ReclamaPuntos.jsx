    ...
    return (
        <div className="premios">
            <div className="contenido" id="reclama-puntos">
                ...
                <span>
                    Por cada carga de  <strong>20Bs</strong>, el sistema te regala <strong>4 puntos</strong>. Esos puntos los puedes cambiar por crédito para seguir jugando o tambien los puedes cambiar por <strong>premios!</strong>
